 ...
 * @author Dell
 */
public class Sutrapur extends Dhaka_South{
     String phone1="01734722991";
      String phone2="01907318902";
      String phone3="01798008099";
      String phone4="01786844598";
      String phone5="01115443433";
      String phone6="02227443344";
      String phone7="03334664455";
      String phone8="01245454555";
      String phone9="01311665266";
      String phone10="01404463777";
    ...
    Sutrapur(String phone1,String phone2,String phone3,String phone4,String phone5, String phone6,String phone7,String phone8,String phone9,String phone10,String phone11){
        this.phone1=phone1;
        this.phone2=phone2;
        this.phone3=phone3;
        this.phone4=phone4;
