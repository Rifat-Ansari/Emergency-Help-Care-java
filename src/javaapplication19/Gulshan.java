 ...
 * @author Dell
 */
public class Gulshan extends Dhaka_North{
     String phone1="01734711001";
      String phone2="01907711002";
      String phone3="01788008099";
      String phone4="01788878098";
      String phone5="01111222233";
      String phone6="02222333344";
      String phone7="03333444455";
      String phone8="01245344555";
      String phone9="01311455666";
      String phone10="01400566777";
      String phone11="029900111";
      
    
    Gulshan(){
        
    }
    Gulshan(String phone1,String phone2,String phone3,String phone4,String phone5, String phone6,String phone7,String phone8,String phone9,String phone10,String phone11){
        this.phone1=phone1;
        this.phone2=phone2;
        this.phone3=phone3;
        this.phone4=phone4;
