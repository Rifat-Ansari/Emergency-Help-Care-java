 ...
 * @author Dell
 */
public class Shabujbagh extends Dhaka_North{
     String phone1="01734755001";
      String phone2="01907991002";
      String phone3="01798448099";
      String phone4="01788158098";
      String phone5="01111662233";
      String phone6="02222773344";
      String phone7="03333774455";
      String phone8="01245114555";
      String phone9="01311885666";
      String phone10="01406566777";
      String phone11="029985111";
      
    
    Shabujbagh(){
        
    }
    Shabujbagh(String phone1,String phone2,String phone3,String phone4,String phone5, String phone6,String phone7,String phone8,String phone9,String phone10,String phone11){
        this.phone1=phone1;
        this.phone2=phone2;
        this.phone3=phone3;
        this.phone4=phone4;
