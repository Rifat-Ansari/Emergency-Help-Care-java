...
public class Demra extends Dhaka_South {
    ...
    Demra(String phone1,String phone2,String phone3,String phone4,String phone5, String phone6,String phone7,String phone8,String phone9,String phone10,String phone11){
        this.phone1=phone1;
        this.phone2=phone2;
        this.phone3=phone3;
        this.phone4=phone4;
    ...
    public String Show1(){
        return"WELCOME TO  Demra RAB SERVICE";
    }
    public String Show2()
    {
    ...
    public String Show4(){
        return"WELCOME TO Demra POLICE STATION";
    }
    public String Show5(){
    ...
    public String Show11(){
        return"WELCOME TO Demra AMBULANCE SERVICE";
    }
    public String Show12(){
        return"1.Monowara Hospital:"+this.phone8;
    }
